module FSharp.Enterprise.AssemblyInfo
...
[<assembly: Guid ("820C5A40-C841-4937-A926-FC12F4C1D3C3")>]

[<assembly: AssemblyTitle ("FSharp.Actor")>]

[<assembly: AssemblyProduct ("FSharp.Actor")>]
